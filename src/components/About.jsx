...
const [view, setView] = useState('01.')
  return (
<motion.div  className='flex  flex-row gap-1  items-center phones:items-center p-12  pl-20 overflow-hidden pb-[100px]  bg-background'  ref={ref} style={{scale:scaleProgress,opacity:opacityProgress}} >
