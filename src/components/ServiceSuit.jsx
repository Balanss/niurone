...
const scaleProgress = isMobile 
  ...
  <div className='flex relative z-[10000000000000000000]  flex-wrap flex-row  items-center justify-center m-auto gap-10  h-auto pb-10'>
    <motion.div className=' grid  md:grid-cols-2  pc:grid-cols-3 mt-2  relative z-10 flex-wrap phones:gap-[4rem] justify-center gap-10 md:flex-2  desktop:flex-1 desktop:w-4/4 phones:p-0 p-10  ' >   
  <Card 
